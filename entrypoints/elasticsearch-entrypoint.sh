...
step ca certificate elasticsearch elasticsearch.crt elasticsearch.key \
  --acme https://setup/acme/acme/directory --force --standalone

chown 1000:0 ca.crt elasticsearch.crt elasticsearch.key
chmod 0600 ca.crt
chmod 0600 elasticsearch.crt elasticsearch.key
popd
